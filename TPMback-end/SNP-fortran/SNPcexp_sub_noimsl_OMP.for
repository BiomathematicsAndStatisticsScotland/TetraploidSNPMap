...
c	*****************************************************
	...
	implicit double precision (a-h,o-z)
      ...
      logical fulloutputl
      integer nl2, l1, l2
      integer snppwd_int(nl2, nl2, 17)
      real(8) snppwd_real(nl2, nl2, 4)
...
c      tnum = 0
	...
	write(8 + 3 * tnum,*)
      ...
      do l=0,1
          do k=0,3
              snppwd_int(l1, l2, l*8+k*2+1) = gp1(vvi(ii), k+1, l+1)
              snppwd_int(l1, l2, l*8+k*2+2) = gp2(vvj(ii), k+1, l+1)
          end do
      end do
      snppwd_int(l1,l2,17) = 1;
      snppwd_real(l1, l2, 1) = rf
      snppwd_real(l1, l2, 2) = lod
      snppwd_real(l1, l2, 3) = lod_diff
      snppwd_real(l1, l2, 4) = rf_next
